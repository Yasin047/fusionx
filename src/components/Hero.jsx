      ...
      <div className={`flex-1 flex justify-start items-start flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]">
            ...
            <span className="text-gradient">FusionX</span> {" "} 
        ...
        <h1  className="font-poppins font-semibold ss:text-[68px] text-[52px] text-white ss:leading-[100px] leading-[75px] w-full"> Universe.</h1>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          A Realm of Blockchain Utility
          with Token and NFTs usecases
